...
"""
This file is the config file used for the PhySO analysis associated to the "Exploring Multi-view Symbolic Regression methods in physical sciences" paper  .
"""
